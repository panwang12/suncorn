...
/* harmony import */ var bootstrap_input_spinner_src_InputSpinner_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! bootstrap-input-spinner/src/InputSpinner.js */ "./node_modules/bootstrap-input-spinner/src/InputSpinner.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#add-to-cart-form-single').on('submit', function (e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      success: function (res) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#cart-total").html(res.cart_total);
  ...
  for (const inputSpinnerElement of inputSpinnerElements) {
    new bootstrap_input_spinner_src_InputSpinner_js__WEBPACK_IMPORTED_MODULE_1__.InputSpinner(inputSpinnerElement);
  }
  const thumbnailWrapper = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.thumbnail-wrapper');
  const thumbnails = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.thumbnails');
  const thumbnailWidth = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.thumbnails img').outerWidth(true);
  const visibleThumbnails = Math.floor(thumbnailWrapper.width() / thumbnailWidth);
  let currentIndex = 0;
  function updateThumbnails() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#arrow-left').removeClass('can-not-click');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#arrow-right').removeClass('can-not-click');
    const newTransform = -currentIndex * thumbnailWidth;
    thumbnails.css('transform', 'translateX(' + newTransform + 'px)');
    if (currentIndex == 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#arrow-left').addClass('can-not-click');
    }
    if (currentIndex >= thumbnails.children().length - visibleThumbnails) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#arrow-right').addClass('can-not-click');
    }
  }
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#arrow-left').on('click', function () {
    if (currentIndex > 0) {
      currentIndex--;
      updateThumbnails();
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#arrow-right').on('click', function () {
    if (currentIndex < thumbnails.children().length - visibleThumbnails) {
      currentIndex++;
      updateThumbnails();
    }
  ...
  document.querySelectorAll('.carousel-indicators img').forEach((indicator, index) => {
    indicator.addEventListener('click', () => {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#productCarousel').carousel(index);
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#productCarousel').on('slide.bs.carousel', function (e) {
    var index = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.relatedTarget).index();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.thumbnails img').removeClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.thumbnails img').eq(index).addClass('active');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.thumbnails div').on('click', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.star').on('click', function () {
    var rating = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('#respond').find('#custom-rating');
    rating.val(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('rating'));
    // 清除所有星星的 active 状态
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.star').removeClass('active');

    // 设置当前星星及之前的星星为 active 状态
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).prevAll('.star').addClass('active');
  });

  // 当鼠标移入星星时
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.star').on('mouseover', function () {
    // 鼠标移入时暂时改变星星颜色
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('hover');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).prevAll('.star').addClass('hover');
  }).on('mouseout', function () {
    // 鼠标移出时恢复星星颜色
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).removeClass('hover');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).prevAll('.star').removeClass('hover');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#commentform').on('submit', function (e) {
    e.preventDefault();
    let alert = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".alert-massage");
    if (alert) {
      alert.remove();
    }
    var $form = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    ...
    let cpage = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment-paginate .active').data('page-index');
    var invalidValue = false;
    dataArr.forEach(obj => {
      let target = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#commentform").find('[name="' + obj.name + '"]');
      if (target) {
        if (!obj.value) {
          target.parent().append(`<div class="alert-massage">*${obj.name} is required</div>`);
          setTimeout(function () {
            target.parent().find(".alert-massage").fadeOut(function () {
              jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).remove(); // 完全移除元素
            });
          }, 3000);
          invalidValue = true;
        }
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      success: function (response) {
        if (response.success) {
          (0,_utility__WEBPACK_IMPORTED_MODULE_2__.showToast)('Thank you for your comment!');
          // $('#commentform').before('<p class="success">Thank you for your comment!</p>');
          resetCommentForm();
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comments-container').html(response.data.html);
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment-paginate').html(response.data.pagination);
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.custom-stars-rating .active').removeClass('active');
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#commentform').before('<p class="error">' + response.data + '</p>');
        }
      },
      error: function (response) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#commentform').before('<p class="error">Something went wrong. Please try again.</p>');
      }
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment-paginate').on('click', '.page-link', function (e) {
    e.preventDefault();
    let cpage = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment-paginate .active').data('page-index');
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      success: function (response) {
        if (response) {
          resetCommentForm();
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comments-container').html(response.data.html); // 将新评论添加到评论列表
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment-paginate .active').removeClass('active');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(`[data-page-index=${cpage}]`).addClass('active');
          if (cpage >= 1) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('html, body').animate({
          scrollTop: jquery__WEBPACK_IMPORTED_MODULE_0___default()('#reviews').offset().top
        }, 100); // 500毫秒的动画时间，可以根据需要调整
      }
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('pre-page').on('click', function () {
    let index = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment-paginate .active').data('page-index');
  });

  // 捕获点击事件
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#comments-container").on('click', '.comment-reply-link', function (e) {
    e.preventDefault(); // 阻止默认的跳转行为
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cancel-reply-link').css("display", "none");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.reply').find('.cancel-reply-link').css("display", "inline-block");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.comment-reply-link').css("display", "inline-block");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).css("display", "none");
    var commentID = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('commentid'); // 获取评论ID
    // var postID = $(this).data('postid'); // 获取文章ID
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.custom-stars-rating .active').removeClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#commentform')[0].reset();
    // 将评论表单移动到该评论下面
    var commentForm = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#respond'); // 获取评论表单
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment_parent').val(commentID); // 设置comment_parent隐藏字段的值为当前评论ID
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.reply').append(commentForm); // 将表单移动到当前评论下
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#comments-container").on('click', '.cancel-reply-link', function (e) {
    e.preventDefault(); // 阻止默认的跳转行为
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cancel-reply-link').css("display", "none");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.comment-reply-link').css("display", "inline-block");
    resetCommentForm();
  ...
  function resetCommentForm() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.custom-stars-rating .active').removeClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#commentform')[0].reset();
    var commentForm = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#respond');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment_parent').val(0);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#review_form").append(commentForm);
  }
});
...
var showToast = function (text) {
  ...
  const toastBootstrap = bootstrap__WEBPACK_IMPORTED_MODULE_0__.Toast.getOrCreateInstance(customToast);
  if (text) {
...
/***/ "./node_modules/bootstrap-input-spinner/src/InputSpinner.js":
/*!******************************************************************!*\
  !*** ./node_modules/bootstrap-input-spinner/src/InputSpinner.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _single_product_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./single-product.js */ "./src/js/single-product.js");
// import $ from "jquery"



jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('#add-to-cart-form').on('submit', function (e) {
    e.preventDefault();
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default().ajax({
      ...
      success: function (res) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()("#cart-total").html(res.cart_total);
        alert(res.message); // Show success message or update cart count, etc.
      }
    });
  });
